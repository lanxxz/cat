...
export const TEXTS = {
  zh: {
    ...
    unlockUpgrades: '解锁升级',
    unlockCost: '解锁费用',
    unlockHint: '付一次解锁该类型所有猫咪的升级',
    locked: '🔒 未解锁',
    upgradeLockedWave: '第3波后解锁升级功能',
    badgeText: 'Lv.',
    unlock: '解锁',
  },
  en: {
    ...
    unlockHint: 'Pay once to unlock upgrades for all cats of this type',
    locked: 'Locked',
    upgradeLockedWave: 'Upgrades unlock after Wave 3',
    badgeText: 'Lv.',
    unlock: 'Unlock',
  },
};
